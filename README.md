...
[![Contributors](https://contrib.rocks/image?repo=datawhalechina/whale-whisper)](https://github.com/datawhalechina/whale-whisper/graphs/contributors)
...
1. **报告问题**：在 [Issues](https://github.com/datawhalechina/whale-whisper/issues) 中描述问题、复现步骤和日志
2. **提交 PR**：
   - Fork 本仓库
...
- PR 请保持改动聚焦，避免混合多个功能
- 提交前请运行测试：`cd backend && python -m compileall -q app` / `cd frontend && pnpm --filter @whalewhisper/web build`
- 遵循现有代码风格和项目规范
